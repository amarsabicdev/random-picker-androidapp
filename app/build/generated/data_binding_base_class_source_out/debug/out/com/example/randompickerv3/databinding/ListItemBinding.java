...
public final class ListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatButton buttonDeleteUser;
  ...
  private ListItemBinding(@NonNull CardView rootView, @NonNull AppCompatButton buttonDeleteUser,
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      AppCompatButton buttonDeleteUser = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ListItemBinding((CardView) rootView, buttonDeleteUser, tvName, tvNumber);
    }
